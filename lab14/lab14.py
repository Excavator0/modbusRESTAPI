...
lab14_logger = create_logger("lab14_logger", "lab14/lab14.log")
        ...
        if device in ["trm200", "trm210"]:
            ...
            if (device == "trm200" and function == "get_temp_1") or \
                ...
                start_address = 1
                    ...
                    (device == "trm210" and function == "get_temp"):
                start_address = 2
            else:
            ...
            if not data.isError():
                lab14_logger.info(f"Лаб14, прибор {device}, функция {function}, прочитано значение {data.registers[0]}")
